...
<form name="book" method="post">
		<div class="selectroom_top">
			<div class="col-md-4 selectroom_left wow fadeInLeft animated" data-wow-delay=".5s">
				...
				<?php
				session_start();
                $_SESSION['img'] = $result->PackageImage; // Store package price in session
                ?>
			</div>
		...
		<div class="selectroom_top">
			...
			<div class="selectroom-info animated wow fadeInUp animated" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp; margin-top: -70px">
				<ul>
					...
					{?>
						<li class="spe" align="center"><?php
                               session_start();
                               $_SESSION['amount'] = $result->PackagePrice; // Store package price in session
                               ?>
					<button type="submit" name="submit2" class="btn-primary btn"><a href="index3.html">Book</a></button>
						</li>
						<?php } else {?>
